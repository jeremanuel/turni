...
sealed class PhysicalPartition with _$PhysicalPartition {
  factory PhysicalPartition({
    ...
    @JsonKey(name: "club_partition_id") required int clubPartitionId,
    @JsonKey(name: "min_players", fromJson: ValueTransformers.fromJsonInt)
    required int minPlayers,
    @JsonKey(
      name: "max_players",
      fromJson: ValueTransformers.fromJsonIntNullable,
    )
    required int? maxPlayers,
    @JsonKey(name: "physical_identifier") required int? physicalIdentifier,
    @JsonKey(name: "is_cover") required String? isCover,
    required String? description,
    @JsonKey(name: "default_session_duration") int? defaultSessionDuration,
    @JsonKey(
  ...
  factory PhysicalPartition.fromJson(Map<String, dynamic> json) =>
      _$PhysicalPartitionFromJson(json);
}
